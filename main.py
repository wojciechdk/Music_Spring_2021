...
# %% Create a sample dataframe for raw data

start_time = time.time()

number_of_records = 627101296
n_samples = 1e6

df_sample_raw = df_raw.sample(fraction=n_samples / number_of_records,
                              withReplacement=False)

print(f'Execution time: {time.time() - start_time:.5f} s.')

# %% Save sample dataframe for raw data
